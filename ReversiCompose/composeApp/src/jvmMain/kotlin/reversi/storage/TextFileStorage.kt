...
/**
* Implementation of the [storage.Storage] interface that persists data by saving it
* as individual text files within a specified base directory on the local file system.
*
* This class uses the [storage.Serializer] contract to convert complex data objects into a
